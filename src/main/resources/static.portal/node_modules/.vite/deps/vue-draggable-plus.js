  ...
  return {
    ...
    animate: function(o, r, i, a) {
      if (a) {
        ...
        o.animatingX = !!d, o.animatingY = !!c, h2(o, "transform", "translate3d(" + d + "px," + c + "px,0)"), this.forRepaintDummy = In(o), h2(o, "transition", "transform " + a + "ms" + (this.options.easing ? " " + this.options.easing : "")), h2(o, "transform", "translate3d(0,0,0)"), typeof o.animated == "number" && clearTimeout(o.animated), o.animated = setTimeout(function() {
...
function Pn(t) {
  ...
  if (e = e || n && n[G], !!e) {
    ...
    window.CustomEvent && !Q && !Ae ? w = new CustomEvent(o, {
      bubbles: true,
      cancelable: true
    ...
    var P = q(q({}, v), Ie.getEventProperties(o, e));
    for (var Y in P)
      w[Y] = P[Y];
  ...
  _prepareDragStart: function(e, n, o) {
    ...
    if (o && !f && o.parentNode === i) {
      ...
      if (D = i, f = o, C = f.parentNode, fe = f.nextSibling, Ye = o, xe = a.group, p.dragged = f, se = {
        ...
        evt: e
      }), a.delay && (!a.delayOnTouchOnly || n) && (!this.nativeDraggable || !(Ae || Q))) {
        if (p.eventCanceled) {
          this._onDrop();
          return;
        }
  ...
  _onDragOver: function(e) {
    ...
    if (We = false, u && !l.disabled && (d ? c || (a = C !== D) : x === this || (this.lastPutMode = xe.checkPull(this, u, f, e)) && s.checkPut(this, u, f, e))) {
      ...
      if (!M || Hn(e, y, this) && !M.animated) {
        ...
        i = N(o);
        var _ = 0, k, B = f.parentNode !== n, A = !Fn(f.animated && f.toRect || r, o.animated && o.toRect || i, y), ie = y ? "top" : "left", ee = _t(o, "top", "top") || _t(f, "top", "top"), ve = ee ? ee.scrollTop : void 0;
        de !== o && (k = i[ie], Ce = false, Me = !A && l.invertSwap || B), _ = Ln(e, o, i, y, A ? 1 : l.swapThreshold, l.invertedSwapThreshold == null ? l.swapThreshold : l.invertedSwapThreshold, Me, de === o);
        var K;
        if (_ !== 0) {
          var ae = j(f);
          do
...
function Xe(t, e, n, o, r, i, a, l) {
  ...
  return window.CustomEvent && !Q && !Ae ? s = new CustomEvent("move", {
    bubbles: true,
    cancelable: true
...
p.mount = function() {
  ...
  e[0].constructor === Array && (e = e[0]), e.forEach(function(o) {
    ...
    o.utils && (p.utils = q(q({}, p.utils), o.utils)), Ie.mount(o);
  });
};
...
function zn() {
  ...
  return t.prototype = {
    ...
    drop: function() {
      this.sortable.nativeDraggable ? E(document, "dragover", this._handleAutoScroll) : (E(document, "pointermove", this._handleFallbackAutoScroll), E(document, "touchmove", this._handleFallbackAutoScroll), E(document, "mousemove", this._handleFallbackAutoScroll)), At(), He(), Cn();
    },
    nulling: function() {
      ze = lt = Ee = st = Se = tt = nt = null, I.length = 0;
    },
    ...
    _handleAutoScroll: function(n, o) {
      ...
      if (ze = n, o || this.options.forceAutoScrollFallback || Ae || Q || _e) {
...
var ot = Rt(function(t, e, n, o) {
  if (e.scroll) {
    ...
    var c = 0, m = Ee;
    do {
      var y = m, v = N(y), w = v.top, T = v.bottom, R = v.left, P = v.right, Y = v.width, M = v.height, b = void 0, _ = void 0, k = y.scrollWidth, B = y.scrollHeight, A = h2(y), ie = y.scrollLeft, ee = y.scrollTop;
      y === s ? (b = Y < k && (A.overflowX === "auto" || A.overflowX === "scroll" || A.overflowX === "visible"), _ = M < B && (A.overflowY === "auto" || A.overflowY === "scroll" || A.overflowY === "visible")) : (b = Y < k && (A.overflowX === "auto" || A.overflowX === "scroll"), _ = M < B && (A.overflowY === "auto" || A.overflowY === "scroll"));
      var ve = b && (Math.abs(P - r) <= a && ie + Y < k) - (Math.abs(R - r) <= a && !!ie), K = _ && (Math.abs(T - i) <= a && ee + M < B) - (Math.abs(w - i) <= a && !!ee);
      if (!I[c])
        for (var ae = 0; ae <= c; ae++)
          I[ae] || (I[ae] = {});
      (I[c].vx != ve || I[c].vy != K || I[c].el !== y) && (I[c].el = y, I[c].vx = ve, I[c].vy = K, clearInterval(I[c].pid), (ve != 0 || K != 0) && (u = true, I[c].pid = setInterval(function() {
        o && this.layer === 0 && p.active._onTouchMove(ze);
        var be = I[this.layer].vy ? I[this.layer].vy * l : 0, te = I[this.layer].vx ? I[this.layer].vx * l : 0;
        typeof d == "function" && d.call(p.dragged.parentNode[G], te, be, t, ze, I[this.layer].el) !== "continue" || Yt(I[this.layer].el, te, be);
      }.bind({
        layer: c
      }), 24))), c++;
...
function zt(...t) {
  ...
  function s(b) {
    var _;
    b.item[It] = l(unref((_ = unref(o)) == null ? void 0 : _[b.oldIndex]));
  }
  function u(b) {
    const _ = b.item[It];
  ...
  function d(b) {
    const { from: _, item: k, oldIndex: B, pullMode: A, clone: ie } = b;
    if (A === "clone") {
      yt(_, k, B), $e(ie);
      return;
    }
  ...
  function c(b) {
    const { from: _, item: k, oldIndex: B, newIndex: A } = b;
    $e(k), yt(_, k, B), sn(unref(o), B, A);
  }
  const m = {
    onUpdate: c,
    onStart: s,
  ...
  function v() {
    var B;
    const A = (B = unref(r)) != null ? B : {}, { immediate: b, clone: _ } = A, k = Ve(A, ["immediate", "clone"]);
    return vn(
      o === null ? {} : m,
      k
    );
